...
GETCPT(DFN,KEY,VALUE,TMGRESULT,DATE) 
  ...
  IF (CPT="3044F")!(CPT="3045F")!(CPT="3046F") DO
  . SET REPORTED=0
  . IF $$HASCPT^TMGRPU1(DFN,CPT,$P(FMDATE,".",1)_".0000",$P(FMDATE,".",1)_".999999") SET TMGRESULT=TMGRESULT_" (ALREADY REPORTED)",REPORTED=1
  ELSE  DO
