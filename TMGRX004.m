...
LINE2ARR(ARR,LINE,DICT)  ;"PARSE LINE INTO AN ARRAY THAT COULD BE REASSEMBLED
  ...
  ;"FOR IDX=1:1:$$WORDLEN(LINE,.DICT) DO
  FOR  QUIT:LINE=""  DO
  . DO GETNXWRD(.LINE,.WORD,.DICT)
  . SET CT=CT+1
...
GETDICT(ARR,IEN22733)  ;"GET A LISTING OF ALL WORDS ASSOCIATED WITH RX
  ...
  ;"DO ADDRFDCT(.ARR,$NAME(^TMG(22733,IEN22733,3,"B")),IEN22733,"DRUG_ABBREV")   
  ;
  ...
  . ;"DO ADDRFDCT(.ARR,$NAME(^TMG(22733,IEN22733,2,SUBIEN,.05,"B")),IEN22733,"FORM_ALIAS")   
  ...
  . . IF UNIT'="" DO ADD2ARR(.ARR,UNIT,"UNIT",FILES("STRENGTHS"),.02,SIENS)
  . . DO ADDRFDT2(.ARR,FILES("STRENGTH ALIASES"),SIENS,"DOSE")    
  . . ;"DO ADDRFDCT(.ARR,$NAME(^TMG(22733,IEN22733,2,SUBIEN,1,DOSEIEN,1,"B")),IEN22733,"DOSE")  ;"STRENGTH_ALIAS    
  . . DO ADDRFDT2(.ARR,FILES("UNIT ALIASES"),SIENS,"UNIT_ALIAS")    
  . . ;"DO ADDRFDCT(.ARR,$NAME(^TMG(22733,IEN22733,2,SUBIEN,1,DOSEIEN,2,"B")),IEN22733,"UNIT_ALIAS")    
...
WORDINFO(WORD,DICT)  ;"characterize word
  ...
  . MERGE WORD("SOURCE")=DICT("ZZSOURCE",WORD)
...
GETMDIEN(OUT,LINE)  ;"GET MEDICATION IEN (IEN22733) FROM LINE
  ...
  QUIT IEN22733
  ; 
MEDIEN(OUT,NAME,LINE)  ;"GET MEDICATION IEN
  NEW IEN22733 SET IEN22733=0
...
GETPRUNT(IEN22733,FORMIEN,STRIEN) ;"GET PREFERRED UNITS FOR FORM, STRENGTH
  ...
  NEW RESULT SET RESULT=$$GETPREF^TMGRX004(ROOT)
  IF RESULT="" DO
...
GETPRFAL(IEN22733,FORMIEN) ;"GET PREFERRED FORM ALIAS
  ...
  QUIT $$GETPREF^TMGRX004(ROOT)
  ;
GETPREF(ROOT)  ;"GET PREFERRED ENTRY (VALUE IN PIECE 1, PREF IN PIECE 2)
