...
GTCHNGLG(TMGRESULT,TMGDUZ,CPRSVERSION) ;"
 ...
 . IF CPRSVERSION="ALL" DO
 . . SET TMGRESULT(1)=$G(TMGRESULT(1))_"<caption>COMPLETE CPRS CHANGE LOG</caption>"
 . ELSE  DO
 . . SET TMGRESULT(1)=$G(TMGRESULT(1))_"<caption>NEW CHANGES FOR THIS VERSION: "_CPRSVERSION_"</caption>"
 . SET TMGRESULT(1)=$G(TMGRESULT(1))_"<th>VERSION</th><th>DATE</th><th>DESCRIPTION</th>"
