...
FIX60(TMGENV,TEST,INFO,IEN60,MODE) ;"60=LABORATORY TEST
  ...
  SET CODE="$$EDITNAME^TMGHL70B("""_TESTNAME_""","""_(INDENTN+2)_""","_MAXLEN_")"
...
F60DN  ;
  QUIT TMGRESULT
  ;
EDITNAME(TESTNAME,INDENTN,MAXLEN) ;"Accept or edit display name of test 
...
EN0 ;
  ...
  . SET TMGMNU(MNUNUM)="USE '"_TESTNAME_"'"_$CHAR(9)_"SAME",MNUNUM=MNUNUM+1
  ELSE  DO
  . WRITE !,!,INDENTSTR,"TEST NAME TOO LONG: [",TESTNAME,"]",!
  SET TMGMNU(MNUNUM)="EDIT name"_$CHAR(9)_"EDIT",MNUNUM=MNUNUM+1
  WRITE !
  SET TMGUSERINPUT=$$MENU^TMGUSRI2(.TMGMNU,"1")
  KILL TMGMNU ;"Prevent from cluttering variable table during debug run
  IF TMGUSERINPUT="SAME" DO  GOTO ENDN
...
FIX64(TMGENV,NLT,INFO,IEN64) ;"64=WKLD CODE
  ...
  . ;"//kt 3/14/22 -- SET CODE="$$TRIMNAME^TMGHL70B("""_TESTNAME_""","""_(INDENTN+2)_""")"
  . SET CODE="$$EDITNAME^TMGHL70B("""_TESTNAME_""","""_(INDENTN+2)_""","_MAXLEN_")"
  . SET TESTNAME=$$EXEC(.TMGENV,CODE)
  . ;"SET TESTNAME=$$TRIMNAME(TESTNAME,INDENTN)
  . IF +TESTNAME<0 SET TMGRESULT=TESTNAME QUIT
