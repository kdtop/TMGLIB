TMGTIUT1 ;TMG/kst-TIU TEMPLATE Dynamic text support ; 2/2/14, 4/11/17, 3/24/21
...
DODYNTXT(IEN,MODE) ;"DO DYNAMIC TEXT
 ...
 NEW TMGDFN SET TMGDFN=$GET(^DISV(DUZ,"^DPT("))
...
DODYNITM(IEN,MODE) ;"DO DYNAMIC ITEMS
 ...
 DO PREPDATA(TMGDFN,.ENTRIES,MINDT,PREPMODE)
 NEW IDX SET IDX=""
...
MKCHDN  QUIT RESULT 
 ;
PREPDATA(TMGDFN,ARRAY,MINDT,MODE) ; 
 ;"Purpose:
...
GETTOPIC(TMGDFN,OUT,MINDT) ; 
 ...
 ;"Result: None
 NEW IEN SET IEN=""
 FOR  SET IEN=+$ORDER(^TMG(22719,"DFN",TMGDFN,IEN)) QUIT:(+IEN'>0)  DO
