...
EXDN
   QUIT TMGRESULT
   ;"
CHARTEXP(GREF,DFN,NOTESTOEXPORT,LABSTOEXPORT,RADTOEXPORT,COVERDATA,SCANSTOEXPORT,EXTRATOEXPORT)  ;"
   ...
   ;"              EACH SET OF RESULT IS SAVED AS AN HTML TABLE (IN DESCENDING ORDER)AS 
...
MAKECOVER(COVERSHEET,COVERIDX,COVERDATA)
   ...
   SET COVERSHEET(COVERIDX)="<TABLE width=""700"" style=""margin-left:auto;margin-right:auto;""><TR><TD>FAMILY PHYSICIANS OF GREENEVILLE PC.</TD></TR>",COVERIDX=COVERIDX+1
