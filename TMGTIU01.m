...
CANSIGN(TMGRESULT,DFN,TIUIEN) ;"
  ...
  . SET TMGRESULT="-1^PHYSICAN EXAM DOESN'T SEEM TO BE EDITED. MUST EDIT IT BEFORE NOTE CAN BE SIGNED"
  IF TIUTEXT[PHRASE2 DO
  . SET TMGRESULT="-1^PHYSICAN EXAM DOESN'T SEEM TO BE ENTERED. MUST ENTERED IT BEFORE NOTE CAN BE SIGNED"  
  QUIT
