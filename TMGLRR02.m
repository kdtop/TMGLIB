...
GETLABS(OUT,DFN,SDT,EDT,OPTION) ;
  ...
  . . . . . ;"note: the following doesn't work quite right and is reversed
  . . . . . SET SUMARR(PNLNAME)="" ;"12/11/18
  . . . . ELSE  DO
  . . . . . SET SUMARR(LABNAME)="" ;"12/11/18
  ...
  . ;". NEW NAME,NAMESTR SET NAME="",NAMESTR=""
  . ;". FOR  SET NAME=$O(SUMARR(NAME)) QUIT:NAME=""  DO
  . ;". . SET NAMESTR=NAMESTR_" "_NAME
  . ;". SET OUT("SUMMARY",$P(ADT,".",1))=NAMESTR
