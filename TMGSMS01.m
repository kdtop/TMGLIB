...
GETMSG(TMGDFN,PROVIEN,TMGDT,REASON,DAYLEAD) ;"Create out-going message.
  ...
  NEW RESULT SET RESULT=""    ;"FAMILY PHYSICIANS OF GREENEVILLE WILL BE CLOSED TODAY DUE TO ICY ROAD CONDITIONS. THIS IN INCLUDES THE LAB. CALL 423-787-7000 AND LEAVE A VOICEMAIL IF YOU HAVE ANY QUESTIONS."
...
SENDNOH2O
  NEW MESSAGE 
  SET MESSAGE="Family Physicians of Greeneville: Due to the water outage in Greene County, our office and lab will be closed for the week of Sept 30-Oct 4, but the physicians will "
  SET MESSAGE=MESSAGE_"be available for phone and video visits. Call 423-787-7000 or visit www.familyphysiciansofgreeneville.com for more information."
  DO ONEMSG(MESSAGE)
  QUIT
  ;" 
SENDWEBSITEMSG
...
ONEMSG(MESSAGE)  ;"
  ...
  . . DO ADDLINE^TMGSMS01(.ARR,"csv:"_PHONENUM_"|"_MESSAGE)
  . . SET COUNT=COUNT+1
  . . ;"  temp  IF COUNT>641 DO ADDLINE^TMGSMS01(.ARR,"csv:"_PHONENUM_"|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14235258434|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14233295446|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14234260236|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14239485433|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14239231407|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14239723215|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14239729155|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14236094948|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14233294443|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14233296660|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14233292567|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14237541078|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14238231446|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14236205199|"_MESSAGE)
  ;"DO ADDLINE^TMGSMS01(.ARR,"csv:14236208417|"_MESSAGE)
  ZWR ARR
