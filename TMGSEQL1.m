TMGSEQL1 ;TMG/kst/Interface with SequelSystems PMS ;7/10/12, 2/2/14, 4/19/18
...
IMPRTINS
  ...
  . NEW DFN 
  . DO FINDPAT^TMGGDFN(.DFN,ACCTNUM,LNAME_","_FNAME,"")
  . IF $$ACTIVEPT^TMGPXR03(DFN)'=1 QUIT
  . W "----------> ",DFN,!
  . DO DELINS^TMGSEQL8(DFN)
  . DO ENSURINS^TMGSEQL8(PNAME,PID,COB,DFN)
IIDN  
  QUIT
  ;"
AUTOIN  ;
