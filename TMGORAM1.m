TMGORAM1 ;TMG/kst-Anticoagulation Stuff ;12/6/17
 ...
 ;"GETMPLAT(OUTREF,IEN,DFN,VSTR) ;"Entry point for TMG ORAM GET TEMPLATE TEXT
 ;
 ;"=======================================================================
...
GETTPLST(RESULT,DUZ) ;"GET TEMPLATES LIST --  TO USE FOR ANTICOAGULATION NOTES
  ...
  QUIT
  ;
GETMPLAT(OUTREF,IEN,DFN,VSTR) ;-- GET TEMPLATE TEXT, WITH OBJECTS RESOLVED
  ...
  . DO GETTEXT^TIUSRVT(.OUTREF,.DFN,.VSTR,.ARR)
  ELSE  DO
