...
ADVCPEDN(TMGDFN,TEST,DATE,DATA,TEXT)  ;"
        ...
        . IF (CPT["9939")!(CPT["G043")!(CPT["G0402") DO    ;"ADDED AWV TO THIS 8/15/24, PER DR. K  ;"ADDED G0402 9/9/25
        . . SET TEST=1
        ...
        . . IF THISDATE>DATE DO
        . . . SET DATE=THISDATE
        . . . SET EXACTDATE=$P($G(^AUPNVSIT(VISIT,0)),"^",1)
        IF EXACTDATE>0 DO
        .  SET LAST=$$EXTDATE^TMGDATE(EXACTDATE,1)
        QUIT LAST
        ;"
