TMGC0Q02 ;TMG/kst/TMG customization of C0Q code ;10/28/12, 2/2/14, 3/24/21
 ...
 ;"=======================================================================
 ;"TESTPT(TMGDFN,PROV,SDTE,EDTE,C0QLIST,VISITS,RESULT,WHY)  ;"Run various tests on one patient.
 ;
 ;"=======================================================================
 ...
 ;"----------------------------
 ;"D TMGRX^TMGC0Q03(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.TEMPRSLT,.TEMPWHY) "//#MUC-1, MUC-2, MUC-4, MUC-5
 ;"D PROBLEM(TMGDFN,PROV,.C0QLIST,.TEMPRSLT,.TEMPWHY)   "//#MUC-3
 ;"D ALLERGY(TMGDFN,PROV,.C0QLIST,.TEMPRSLT,.TEMPWHY)   "//#MUC-6
 ;"D DEMO(TMGDFN,PROV,.C0QLIST,.TEMPRSLT,.TEMPWHY)      "//#MUC-7
 ;"D VITALS(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.TEMPRSLT,.TEMPWHY)   "//#MUC-8
 ;"D SMOKING^TMGC0Q03(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.TEMPRSLT,.TEMPWHY)   "//#MUC-9
 ...
 ;"D CLINSUM(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.TEMPRSLT,.TEMPWHY) "//#MUC-13
 ...
 ;"DO PTREM(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.TEMPRSLT,.TEMPWHY)  ;"REMINDERS SENT TO PATIENT 
 ;//#4 -- MUM-7 -- will get via HasMedRecon list
 ;//#5 -- MUM-8 -- Will get through consult referal note-title and addendum when sent. 
 ;"DO CONTCARE^TMGC0Q03(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.VISITS,.TEMPRSLT,.TEMPWHY) 
 ;"=============================
 ;//Below are numbered from the list of 3 core clinical quality measures (CCQM) (3 required)
 ;//CCQM-1 -- HTN: 
 ;"DO HTN^TMGC0QT2(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.VISITS,.TEMPRSLT,.TEMPWHY) 
 ;//CCQM-2 -- Tobacco prevention
 ;//   Will get through: HasMokingStatus/Over17 and IsTobaccoUser/HasTobaccoIntervention
 ;//CCQM-2 -- Obesity: 
 ;"DO OBESITY^TMGC0Q03(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.VISITS,.TEMPRSLT,.TEMPWHY) "//CCQM-3 -- Weight intervention:
 ;"=============================
 ...
 ;"DO DM^TMGC0Q03(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.VISITS,.TEMPRSLT,.TEMPWHY) "//CQM-1 & CQM-38
 ;//CQM-6 -- Pneumococal vaccination
 ;"DO PNEUMO^TMGC0Q03(TMGDFN,PROV,SDTE,EDTE,.C0QLIST,.VISITS,.TEMPRSLT,.TEMPWHY) "//CQM-6
 ;"----------------------------
 ; 
TESTPT(TMGDFN,PROV,SDTE,EDTE,C0QLIST,VISITS,TMGC0QRESULT,TMGC0QWHY)  ;"Run various tests on one patient.
        ...
        . . NEW CODE SET CODE="DO "_TAG_"^"_ROUTINE_"(TMGDFN,PROV,SDTE,EDTE,.VISITS,.C0QLIST,.TEMPRSLT,.TEMPWHY,ZYR)"
        . . XECUTE CODE
