...
MKHLMARR(MSGARRAY,MSH,IEN772,IEN773) ;"MAKE HL7 MESSAGE FROM ARRAY  (2 records, 1 each in 772, 773)
        ...
        NEW TEMPARR SET TEMPARR(1)=MSH
        DO WP^DIE(773,IEN773_",",200,"K","TEMPARR","TMGMSG")
...
XFRMFACILITY(FACILITY,TMGU) ;"Transform sending facility before any processing is done.
        ...
        IF "^JMHZ^SSHZ^WH^SN^MRMC^CORP^NNCH^LPH^GHC"[FACILITY SET SHOULDMAP=1    
...
MSH2IENA(MSH,INFO) ;"MSH HEADER TO IEN INFO ARRAY
        ...
        IF VERID="2.5.1" SET VERID="2.3"    ;"6/1/20  ADDED FOR WEIRD MSH HEADER FROM LAUGHLIN        
