...
MNU1 ;
   ...
   . . IF $DATA(OPTIONS(DISPNUMBER,"COLOR","fg")) SET OPTIONS(DISPNUMBER,"COLOR","FG")=$G(OPTIONS(DISPNUMBER,"COLOR","fg"))
   . . IF $DATA(OPTIONS(DISPNUMBER,"COLOR","bg")) SET OPTIONS(DISPNUMBER,"COLOR","BG")=$G(OPTIONS(DISPNUMBER,"COLOR","bg"))
