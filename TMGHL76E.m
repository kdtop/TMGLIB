TMGHL76E ;TMG/kst-HL7 Processing Error/Alert handling; 11/18/16, 3/24/21
  ...
  ;"NOTE: I think this entire file is outdated.  I initially had different error handlers
  ;"      for different HL7 sources, but then debugging them all was causing problems.
  ;"      So they were merged back together (into TMGHL7E).  I think this is 
  ;"      residual code.  I will comment out for now and ensure it is not really 
  ;"      needed.  I think this code is duplicates of code found elsewhere.
  ;"      Consider deleting later.   //kt 7/31/23
