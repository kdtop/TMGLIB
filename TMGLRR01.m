TMGLRR01 ;TMG/kst-Entry point for reading from LAB DATA file ;12/28/14
...
GFRMTLAB(PTID,LAB,OUT,OPTION) ;"GET FORMATED LAB REPORT
        ...
        . NEW DT SET DT=""
        . FOR  SET DT=$ORDER(TEMP(IEN60,DT),-1) QUIT:(+DT'>0)  DO
...
GETVALS(PTID,LAB,OUT,OPTION) ;"GET VALUES FOR LAB TEST 60       
        ...
        NEW SDT SET SDT=$GET(OPTION("SDT"),9999999) NEW RSDT SET RSDT=9999999-SDT
        NEW EDT SET EDT=$GET(OPTION("EDT"),0) NEW REDT SET REDT=9999999-EDT
