...
NETMESSLOC()  ;"Network folder path
  ...
  ;"
GETMYNAM(TMGRESULT,IPADDRESS,USER) ;"
  ...
  IF IPADDRESS="192.168.3.94" SET IPADDRESS=$G(USER)_"@"_IPADDRESS
...
GETUSERS(TMGRESULT)  ;"
 ...
 QUIT
 ;"
SEND1MSG(TMGRESULT,USERTO,USERFROM,MESSAGE,NOTECREATED,TMGDFN)  ;"
 ...
 SET TMGDFN=+$G(TMGDFN) ;"not required
 ...
 IF TMGDFN>0 DO
 . DO GETFAPPT(.MESSAGE,TMGDFN)
 DO AR2HFSFP^TMGIOUT3("MESSAGE",OUTFILENAME)
 QUIT
 ;"
GETFAPPT(MESSAGE,TMGDFN) ;"
 NEW NEXTAPPT DO NEXTAPPT^TMGRPT2(.NEXTAPPT,TMGDFN,0)
 IF NEXTAPPT["NO UPCOMING APPOINTMENT FOUND" QUIT
 NEW MSGIDX SET MSGIDX=$O(MESSAGE(999999),-1)+1
 SET MESSAGE(MSGIDX)=$C(13,10)_$C(13,10)_"NOTE: "_NEXTAPPT
 QUIT
 ;"
UNIQUEFN(TO,FROM)  ;"
