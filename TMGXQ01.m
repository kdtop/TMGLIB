...
HNDLSEL(TMGPSCRLARR,OPTION,INFO) ;
  ...
  . SET TEMPARR(RETURN)=""
  SET IDX=0,TMGSELRESULT=""
  FOR  SET IDX=$ORDER(TEMPARR(IDX)) QUIT:IDX'>0  DO
  . IF TMGSELRESULT'="" SET TMGSELRESULT=TMGSELRESULT_","
  . SET TMGSELRESULT=TMGSELRESULT_IDX 
  SET TMGSCLRMSG="^"  ;"Tells scroller to exit.  
  ;"NOTE: TMGSELRESULT is used in global scope, and is used for result of scroller.  
  QUIT
