...
PRTALRGY  ;"
       ...
       . NEW ADDRLINE SET ADDRLINE=$G(^DPT(TMGDFN,.11))
       . NEW ADDR2 SET ADDR2=$P(ADDRLINE,"^",2)
       . IF ADDR2'="" SET ADDR2=" "_ADDR2
       . NEW STATE SET STATE=$P($G(^DIC(5,$P(ADDRLINE,"^",5)),0),"^",2)
       . NEW ADDRESS SET ADDRESS=$P(ADDRLINE,"^",1)_" "_ADDR2_$P(ADDRLINE,"^",4)_", "_STATE_" "_$P(ADDRLINE,"^",6)
       . SET Y=DOB DO DD^%DT SET DOB=Y
       . WRITE NAME," (",DOB,")"," ",ADDRESS,!
