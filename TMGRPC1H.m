...
TOCPARSE(TMGOUT,OUTIDX,TMGIN)
  ...
  . IF OUTSIDEHPI DO
  . . ;"//kt 6/3/25 SET DELIMITER=$$NEXTCH^TMGSTUT3(TMGHPI,0,"-- [","HISTORY OF PRESENT ILLNESS (HPI):","PAST MEDICAL HISTORY (PMH)","PHYSICAL EXAM (PE)","REVIEW OF SYSTEMS","ASSESSMENT &amp; PLAN","FOLLOW UP APPT:") 
  . . SET DELIMITER=$$NEXTFRAG^TMGSTUT3(TMGHPI,0,.DIVS)  ;"//kt 6/3/25 
  . ELSE  DO
  . . ;"//kt 6/3/25 SET DELIMITER=$$NEXTCH^TMGSTUT3(TMGHPI,0,"*","<LI>","-- [","HISTORY OF PRESENT ILLNESS (HPI):","PAST MEDICAL HISTORY (PMH)","PHYSICAL EXAM (PE)","REVIEW OF SYSTEMS","ASSESSMENT &amp; PLAN","FOLLOW UP APPT:")
  . . SET DELIMITER=$$NEXTFRAG^TMGSTUT3(TMGHPI,0,.DIVS2)  ;"//kt 6/3/25 
  . NEW TOPIC
  . IF DELIMITER="-- [" DO
...
TOCTEST(TMGIN)
 ...
 ;"   NEW DIVS,DIVS2
 ;"   SET DIV("-- [")=""
 ;"   SET DIV("HISTORY OF PRESENT ILLNESS (HPI):")=""
 ;"   SET DIV("PAST MEDICAL HISTORY (PMH)")=""
 ;"   SET DIV("PHYSICAL EXAM (PE)")=""
 ;"   SET DIV("REVIEW OF SYSTEMS")=""
 ;"   SET DIV("ASSESSMENT &amp; PLAN")=""
 ;"   SET DIV("FOLLOW UP APPT:")=""
 ;"   MERGE DIVS2=DIVS
 ;"   SET DIVS2("*")=""
 ;"   SET DIVS2("<LI>")=""
 ;"   SET DIVS2("<li>")=""  
