TMGSMS03 ;TMG/kst/OS SMS Message -- Alert Handlers;12/23/14, 3/24/21
...
GETNUSRS(OUT,PHONENUM) ;"GET ALL PATIENTS USING PHONE NUMBER
  ...
  FOR  SET TMGDFN=$ORDER(THREAD("PHONE NUM USERS",TMGDFN)) QUIT:+TMGDFN'>0  DO
  . NEW ONENAME SET ONENAME=$PIECE($GET(^DPT(TMGDFN,0)),"^",1)
