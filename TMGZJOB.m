...
INTRPT(OTHERJOB,COMMAND,QUIET)  ;Send MUPIP intrpt
  ...
  . SET DONE=(DELTASEC>5)  ;"TIMEOUT AFTER 5 SEC.    
  ;  
...
CONSOLE  ;"provide console interface to ZJOB
  ...
  . SET OPTION("COLORS","HIGH")=$$COLORPAIR^TMGTERM("BLACK","YELLOW",.TMPCLR) 
  . SET OPTION("COLORS","INACTIVE HIGH")=$$COLORPAIR^TMGTERM("WHITE","GREY",.TMPCLR) 
  . SET OPTION("COLORS","HEADER")=$$COLORPAIR^TMGTERM("BLACK","GREY",.TMPCLR)
  . SET OPTION("COLORS","FOOTER")=$$COLORPAIR^TMGTERM("BLACK","GREY",.TMPCLR)
  . SET OPTION("COLORS","TOP LINE")=$$COLORPAIR^TMGTERM("BLACK","GREY",.TMPCLR)
  . SET OPTION("COLORS","BOTTOM LINE")=$$COLORPAIR^TMGTERM("BLACK","GREY",.TMPCLR)
  . SET OPTION("COLORS","INDEX")=$$COLORPAIR^TMGTERM("BLACK","WHITE",.TMPCLR)
  . ; 
  . SET OPTION("COLUMNS",2,"COLORS","NORM")=$$COLORPAIR^TMGTERM("WHITE","CYAN",.TMPCLR)
  . SET OPTION("COLUMNS",2,"COLORS","HIGH")=$$COLORPAIR^TMGTERM("BLACK","YELLOW",.TMPCLR) 
  . SET OPTION("COLUMNS",2,"COLORS","INACTIVE HIGH")=$$COLORPAIR^TMGTERM("WHITE","GREY",.TMPCLR) 
  . SET OPTION("COLUMNS",2,"COLORS","INDEX")=$$COLORPAIR^TMGTERM("BLACK","WHITE",.TMPCLR)
  . ;
  . SET OPTION("COLUMNS",3,"COLORS","NORM")=$$COLORPAIR^TMGTERM("WHITE","BLUE",.TMPCLR)
  . SET OPTION("COLUMNS",3,"COLORS","HIGH")=$$COLORPAIR^TMGTERM("WHITE","GREY",.TMPCLR) 
  . SET OPTION("COLUMNS",3,"COLORS","HI-SEL")=$$COLORPAIR^TMGTERM("WHITE","MAGENTA",.TMPCLR) 
  . SET OPTION("COLUMNS",3,"COLORS","INDEX")=$$COLORPAIR^TMGTERM("BLACK","WHITE",.TMPCLR)
  . SET OPTION("COLUMNS",3,"COLORS","SELECTED")=$$COLORPAIR^TMGTERM("WHITE","RED",.TMPCLR)
  . ;
