TMGDPTN2 ;BPOIFO/KEITH - NAME STANDARDIZATION ; 12 Aug 2002@20:20, 2/2/14; 6/23/15 (kt)
         ;;1.0;TMG-LIB;**1**;2/15/15
        ;;5.3;Registration;**244**;Aug 13, 1993
        ;
        ;"Code originally taken from DPTNAME1.m
 ;
 ;"~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--~--
...
CVALID(DGC,DGX,DGM)        ;Name component validation
        ...
        S DGX=$$FORMAT^TMGDPTN1(DGX,$P(DGL,U),$P(DGL,U,2),,3,,1,1)
