...
CKRM ;       
  ...
  IF IEN22733>0 SET IDX=IDX+1,MENU(IDX)="Show "_MEDNAME_"'s registered strengths"_$CHAR(9)_"SHOWSTRT"
  IF IEN22733>0 SET IDX=IDX+1,MENU(IDX)="Edit "_MEDNAME_"'s registered strengths"_$CHAR(9)_"EDITSTRENGTHS"    
