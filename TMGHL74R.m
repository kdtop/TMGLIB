...
OBR32   ;"Transform Principle results interpretor (radiologist)
        ...
        IF TMGVALUE="" SET TMGVALUE="0"_TMGU(2)_"DOCTOR"_TMGU(2)_"UNSPECIFIED"
...
ENRADDN QUIT TMGRESULT
        ;
ADDRAD(FMNAME,TMGU)  ;"ADD RADIOLOGIST TO NEW PERSON FILE.
        ;"Input: Name of radiologist to add: 'LNAME,FNAME' 
        ;"Return 'DFN^<NAME>^TMG', or -1^Message
        QUIT $$ADDPROV^TMGHL72(.FMNAME,.TMGU)
...
NSURDPER(RAPROV)  ;"Ensure radiologist record had proper permissions etc
        ...
        IF ($PIECE(ZN,"^",7)'="1")&($PIECE(ZN,"^",1)'="DOCTOR,UNSPECIFIED") SET TMGFDA(200,TMGIENS,7)="YES"  ;"DISUSER  <-- INACTIVATES USER SO CAN'T LOG IN WITH ETC.
