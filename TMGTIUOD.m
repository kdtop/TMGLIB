TMGTIUOD ;TMG/kst-TIU OBJECTS ; 01/12/17
...
RISKGRP(TMGDFN,AODT,TMGTEXT)  ;
  ...
  SET TMGTEXT=""
  NEW AGE SET AGE=$$AGE^TMGC0QT4(TMGDFN,.AODT)
  NEW LOWAGE SET LOWAGE=(AGE'>75)
  SET TMGTEXT=$$TFTEXT(LOWAGE,"Age<=75","Age>75")
  ...
  . IF LOWAGE SET TMGRESULT=RSLT(3),TMGTEXT=TMGTEXT_" --> "_RSLT(3) QUIT
  ...
  . IF LOWAGE SET TMGRESULT=RSLT(3),TMGTEXT=TMGTEXT_RSLT(3) QUIT
