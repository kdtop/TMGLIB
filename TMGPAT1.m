...
DOIENS(PCKINIT,NEXTIENS,NEXTPATCH,PCKDIRFNAME)
        ...
        . . WRITE " -------------------------------------------------------------",!
        . . WRITE !,"== DOWNLOAD ===================================================",!
        . . IF $$DownloadFile^TMGKERNL(Info("KID URL"),DESTPATH,1)
        . . WRITE !,"===============================================================",!
        . . WRITE " -------------------------------------------------------------",!        
        . . ;"//kt mod 7/14/15
        . . ;"WRITE !,"Attempt to download ",FNAME," from patch repository server?",!
        ...
        . . ;"IF %'=1 QUIT
        . . ;"IF $$DownloadPATCH^TMGPAT2(FNAME,"ftp://",.OPTION,.TEMPMsg,.Info)=0 DO
