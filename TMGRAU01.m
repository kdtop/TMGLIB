...
GETRADFN(TMGDFN)  ;"
  ...
  QUIT TMGRESULT
  ;
DELSTUDY(TMGRESULT,IENS)  ;"THIS IS THE ENTRY POINT FOR "TMG DELETE ONE RAD STUDY"
  SET TMGRESULT=$$DELRAD(IENS)
  IF $P(TMGRESULT,"^",1)="1" SET TMGRESULT="1^This study was successfully deleted."
  QUIT
  ;"
